...
- ✍️ **Отправка SMS** — ответ прямо из чата, или новая переписка через кнопку «Новое сообщение»
...
- 📱 Адаптив для мобилок: кнопка меню для открытия сайдбара HA, кнопка назад, полноширинная кнопка «Новое сообщение»
