...
### v3.1.0 — Карточка для дашборда встроена
- 📊 Lovelace-карточка для дашборда теперь встроена прямо в интеграцию — отдельная установка через HACS больше не нужна. Автоматически доступна в выборе карточек сразу после настройки интеграции.
