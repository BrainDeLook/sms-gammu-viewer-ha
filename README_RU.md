...
<p align="center">
  <img src="screenshots/mobile.jpg" alt="Вид на мобильном" width="32%">
  <br>
  <sub>Мобильная версия — список контактов на весь экран, кнопка меню и плавающая кнопка нового сообщения</sub>
</p>
