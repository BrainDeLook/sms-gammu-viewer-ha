...
### v3.0.0 — Сущности звонков, телефонная книга, язык в настройках
- 🚪 Новая функция сущностей звонков: создавай `cover`/`button` сущности, звонящие на фиксированный номер — для ворот, гаражных ворот, домофонов. Настройка через Настройки → SMS Gammu Viewer → Настроить → Сущности звонков. **Перезапусти Home Assistant после добавления/изменения/удаления сущности, чтобы изменения вступили в силу.**
- 📇 Телефонная книга — сохраняй имена контактов, показываются в списке диалогов, истории звонков и шапке чата
- 🌐 Язык интерфейса перенесён в настройки интеграции (переключатель 🌐 в панели убран)
- 🐛 Исправлен критический баг, при котором сохранение настроек могло незаметно стирать настроенные сущности звонков
- 🐛 Исправлено зависшее состояние «открывается» в сторонних умных домах (Алиса, Алекса, Google Home) для cover-сущностей звонков
- 🐛 Исправлена давняя ошибка перевода, причиной которой оказался забытый, устаревший файл `translations/en.json`
