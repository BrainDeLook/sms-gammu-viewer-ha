export default {
  ...
  enable_people_folder: "Включить папку «Люди»",
  enable_brands_folder: "Включить папку «Бренды»",
  ...
  back: "Назад",
  new_folder_with_contact: "Создать папку с этим контактом",
  folder_auto: "Папка формируется автоматически",
  ...
  people_folder_help: "Чаты без логотипов добавляются автоматически. Снимите отметку, чтобы исключить чат, или отметьте любой чат, чтобы вручную добавить его в «Люди».",
